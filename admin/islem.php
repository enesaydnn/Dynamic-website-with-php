...
if(isset($_POST['ayarkaydet'])){
    // echo htmlspecialchars(); XSS açıkları için böyle kullanılıyor.
...
if(isset($_POST['hakkimizdakaydet'])){
    ...
    if($_FILES['resim']["size"]>0){
        ...
        $uploads_dir='C:\xampp\htdocs\admin\resimler\hakkimizda';
        @$tmp_name=$_FILES['resim'] ["tmp_name"];
        @$name=$_FILES['resim'] ["name"];

$sayi1=rand(1,0000000);
$sayi2=rand(1,0000000);
$sayi3=rand(1,0000000);
...
if(isset($_POST['sliderkaydet'])){
    ...
    if($_FILES['resim']["size"]>0){
        ...
        $uploads_dir='C:\xampp\htdocs\admin\resimler\slider';
        @$tmp_name=$_FILES['resim'] ["tmp_name"];
        @$name=$_FILES['resim'] ["name"];
...
$sayi3=rand(1,0000000);
        ...
        $kaydet=$baglanti->prepare("UPDATE slider1 SET 
...
if(isset($_POST['ekipkaydet'])){
    ...
    $uploads_dir='C:\xampp\htdocs\admin\resimler\ekip';
    @$tmp_name=$_FILES['resim'] ["tmp_name"];
    @$name=$_FILES['resim'] ["name"];
...
if(isset($_POST['galerikaydet'])){
    ...
    $uploads_dir='C:\xampp\htdocs\admin\resimler\galeri';
    @$tmp_name=$_FILES['resim'] ["tmp_name"];
    @$name=$_FILES['resim'] ["name"];
...
if($insert) {
    ...
    Header("Location:galeri.php?&durum=yes");   
}
...
$uploads_dir='C:\xampp\htdocs\admin\resimler\blog';
@$tmp_name=$_FILES['resim'] ["tmp_name"];
@$name=$_FILES['resim'] ["name"];
...
if (isset($_POST['blogduzenle'])) {
    ...
    $eskiresim=$_POST['eskiresim'];
        unlink("/admin/resimler/blog/$eskiresim");
...
if (isset($_POST['icerikkaydet'])) {
	$katid=$_POST['katid'];
	$uploads_dir='C:\xampp\htdocs\admin\resimler\icerik';
@$tmp_name=$_FILES['resim'] ["tmp_name"];
@$name=$_FILES['resim'] ["name"];
...
if ($insert) {
Header("Location:/WEB/index.php?durum=yes");
}else{
    Header("Location:/WEB/index.php?durum=no");
}
